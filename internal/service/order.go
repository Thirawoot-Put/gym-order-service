...
func (s *OrderService) CreateOrder(order *domain.OrderEntity) error {
	// add business logic here
	return s.repo.Create(order)
}

func (s *OrderService) UpdateOrder(order *domain.OrderEntity) error {
	// add business logic here
	return s.repo.Update(order)
}

func (s *OrderService) GetOrderByUserId(userId uint) ([]domain.OrderEntity, error) {
	// add business logic here
